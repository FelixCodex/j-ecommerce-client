			...
			{error ? (
				...
				<div className='mt-4 h-fit flex w-full rounded-lg'>
					<div className='w-full h-[3.75rem] rounded-lg'>
						<div className='w-full h-10 bg-[--light_400] shadow-inner shadow-[--light_300] overflow-hidden rounded-lg'>
							<div
							...
							>
								<p
									className={`text-lg font-medium text-[--light_900] ${
										downloadData
...
const paused = useRef(false);
  ...
  {paused.current ? (
    <Play
      className="h-9 w-9 p-1 transition-colors  hover:bg-[--light_500] border border-transparent hover:border-[--light_400] rounded-full"
