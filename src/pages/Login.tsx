		...
		<main className='min-h-screen-minus-64 dottedBackground flex justify-center py-12 px-4 sm:px-6 lg:px-8'>
			<div className='max-w-lg w-full space-y-8'>
				...
				<section className='bg-[--bg_sec] rounded-lg shadow-md p-7'>
                    ...
                    border bg-[--bg_prim] text-[--light_0] border-[--light_500] 
                  ...
                  `}
								...
								{isEmailValid !== null && (
									...
									>
										...
										<span
											id='email-error'
											className='tooltiptext group-hover:visible max-w-[80vw] after:border-transparent right-[140%] lg:right-auto lg:left-[140%] shadow-sm shadow-[--light_500] text-[--light_0] bg-[--bg_sec] after:border-r-[--light_800]'
										>
											{isEmailValid
                    ...
                    border bg-[--bg_prim] border-[--light_500] text-[--light_0] 
                    placeholder-gray-500 focus:outline-none focus:ring-[--brand_color] 
                    focus:border-[--brand_color] focus:z-10
                  ...
                  `}
								...
								<div
									className='absolute w-6 h-6 eye'
									style={{ color: '#111' }}
								>
									<button
										type='button'
